...
module.exports = function (_a) {
    ...
    var host = node + ".tendzin.com";
    return {
        transact: function (events, uuid, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, patchRequest("range/day/" + uuid, token, { events: events }, __assign({ host: host }, options))];
                        case 1:
                            _a.sent();
        ...
        spawn: function (options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, postRequest('range/day', token, null, __assign({ host: host }, options))];
                        case 1:
        ...
        getInventory: function (uuid, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, getRequest("range/day/" + uuid + "/inventories", token, __assign({ host: host }, options))];
                        case 1:
                            result = (_a.sent()).result;
                            return [2 /*return*/, result];
                    }
        ...
        getContiguousInventory: function (uuid, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, getRequest("range/day/" + uuid + "/contiguous-inventories", token, __assign({ host: host }, options))];
                        case 1:
                            result = (_a.sent()).result;
                            return [2 /*return*/, result];
                    }
        ...
        getStatus: function (uuid, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, getRequest("range/day/" + uuid, token, __assign({ host: host }, options))];
                        case 1:
                            result = (_a.sent()).result;
                            return [2 /*return*/, result];
                    }
